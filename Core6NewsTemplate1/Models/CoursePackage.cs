namespace WebOS.Models
{
    ...
    public class CoursePackage
    {
        ...
        [Required(ErrorMessage = "اسم الباقة حقل مطلوب")]
        [StringLength(100, ErrorMessage = "MinMaxTextFieldError", MinimumLength = 5)]
        [Display(Name = "إسم الباقة  باللغة العربية")]
        public string ArName { get; set; }


        [StringLength(100, ErrorMessage = "MinMaxTextFieldError", MinimumLength = 5)]
        [Display(Name = "إسم الباقة  باللغة الانكليزية")]
        ...
        [StringLength(5000, ErrorMessage = "MinMaxTextFieldError", MinimumLength = 0)]
        [Display(Name = "مخرجات الباقة")]
        public string LearningOutcomes { get; set; }

        [StringLength(5000, ErrorMessage = "MinMaxTextFieldError", MinimumLength = 0)]
        [Display(Name = "متطلبات دخول الباقة")]
